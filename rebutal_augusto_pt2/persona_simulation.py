...
class PersonaSimulator:
    ...
    def __init__(
        ...
        personas_dict: Optional[Dict[str, str]] = None
    ):
        """
        ...
        Args:
            ...
            personas_dict: Dictionary of persona names mapping to their bio (defaults to PERSONAS)
        """
        self.personas_dict = personas_dict or PERSONAS
        # Set up API client
    ...
    async def _get_single_feedback(
        ...
        persona_bio = self.personas_dict[persona_name]
    ...
    async def get_all_persona_feedback(
        ...
        """
        personas = personas or list(self.personas_dict.keys())
